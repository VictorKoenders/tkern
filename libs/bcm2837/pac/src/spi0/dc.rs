...
pub type RPANIC_W<'a> = crate::FieldWriter<'a, u32, DC_SPEC, u8, u8, 8, 24>;
...
pub type RDREQ_W<'a> = crate::FieldWriter<'a, u32, DC_SPEC, u8, u8, 8, 16>;
...
pub type TPANIC_W<'a> = crate::FieldWriter<'a, u32, DC_SPEC, u8, u8, 8, 8>;
...
pub type TDREQ_W<'a> = crate::FieldWriter<'a, u32, DC_SPEC, u8, u8, 8, 0>;
impl R {
