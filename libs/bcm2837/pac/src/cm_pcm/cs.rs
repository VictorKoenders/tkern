...
pub type PASSWD_W<'a> = crate::FieldWriter<'a, u32, CS_SPEC, u8, PASSWD_AW, 8, 24>;
impl<'a> PASSWD_W<'a> {
    #[doc = "`1011010`"]
    #[inline(always)]
...
pub type MASH_W<'a> = crate::FieldWriter<'a, u32, CS_SPEC, u8, u8, 2, 9>;
...
pub type FLIP_W<'a> = crate::BitWriter<'a, u32, CS_SPEC, bool, 8>;
...
pub type KILL_W<'a> = crate::BitWriter<'a, u32, CS_SPEC, bool, 5>;
...
pub type ENAB_W<'a> = crate::BitWriter<'a, u32, CS_SPEC, bool, 4>;
#[doc = "Clock source\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
#[repr(u8)]
pub enum SRC_A {
...
pub type SRC_W<'a> = crate::FieldWriter<'a, u32, CS_SPEC, u8, SRC_A, 4, 0>;
impl<'a> SRC_W<'a> {
    #[doc = "`1`"]
    #[inline(always)]
