...
pub type TUNED_W<'a> = crate::BitWriter<'a, u32, CONTROL2_SPEC, bool, 23>;
...
pub type TUNEON_W<'a> = crate::BitWriter<'a, u32, CONTROL2_SPEC, bool, 22>;
...
pub type UHSMODE_W<'a> = crate::FieldWriter<'a, u32, CONTROL2_SPEC, u8, UHSMODE_A, 3, 16>;
impl<'a> UHSMODE_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
