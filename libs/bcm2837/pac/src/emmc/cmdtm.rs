...
pub type CMD_INDEX_W<'a> = crate::FieldWriter<'a, u32, CMDTM_SPEC, u8, u8, 6, 24>;
...
pub type CMD_TYPE_W<'a> = crate::FieldWriterSafe<'a, u32, CMDTM_SPEC, u8, CMD_TYPE_A, 2, 22>;
impl<'a> CMD_TYPE_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type CMD_ISDATA_W<'a> = crate::BitWriter<'a, u32, CMDTM_SPEC, bool, 21>;
...
pub type CMD_IXCHK_EN_W<'a> = crate::BitWriter<'a, u32, CMDTM_SPEC, bool, 20>;
...
pub type CMD_CRCCHK_EN_W<'a> = crate::BitWriter<'a, u32, CMDTM_SPEC, bool, 19>;
...
pub type CMD_RSPNS_TYPE_R = crate::FieldReader<u8, CMD_RSPNS_TYPE_A>;
...
pub type CMD_RSPNS_TYPE_W<'a> =
    crate::FieldWriterSafe<'a, u32, CMDTM_SPEC, u8, CMD_RSPNS_TYPE_A, 2, 16>;
...
pub type TM_MULTI_BLOCK_W<'a> = crate::BitWriter<'a, u32, CMDTM_SPEC, TM_MULTI_BLOCK_A, 5>;
...
pub type TM_DAT_DIR_W<'a> = crate::BitWriter<'a, u32, CMDTM_SPEC, TM_DAT_DIR_A, 4>;
...
pub type TM_AUTO_CMD_EN_W<'a> = crate::FieldWriter<'a, u32, CMDTM_SPEC, u8, TM_AUTO_CMD_EN_A, 2, 2>;
...
pub type TM_BLKCNT_EN_W<'a> = crate::BitWriter<'a, u32, CMDTM_SPEC, bool, 1>;
impl R {
