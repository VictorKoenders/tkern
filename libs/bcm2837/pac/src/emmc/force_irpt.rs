...
pub type ACMD_ERR_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 24>;
...
pub type CBAD_ERR_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 19>;
...
pub type CEND_ERR_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 18>;
...
pub type CCRC_ERR_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 17>;
#[doc = "Field `CTO_ERR` reader - Command timeout"]
pub type CTO_ERR_R = crate::BitReader<bool>;
#[doc = "Field `CTO_ERR` writer - Command timeout"]
pub type CTO_ERR_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 16>;
...
pub type ENDBOOT_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 14>;
...
pub type BOOTACK_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 13>;
...
pub type RETUNE_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 12>;
...
pub type CARD_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 8>;
...
pub type READ_RDY_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 5>;
...
pub type WRITE_RDY_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 4>;
...
pub type BLOCK_GAP_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 2>;
...
pub type DATA_DONE_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 1>;
...
pub type CMD_DONE_W<'a> = crate::BitWriter<'a, u32, FORCE_IRPT_SPEC, bool, 0>;
impl R {
