...
pub type VENDOR_W<'a> = crate::FieldWriter<'a, u32, SLOTISR_VER_SPEC, u8, u8, 8, 24>;
...
pub type SDVERSION_W<'a> = crate::FieldWriter<'a, u32, SLOTISR_VER_SPEC, u8, u8, 8, 16>;
...
pub type SLOT_STATUS_W<'a> = crate::FieldWriter<'a, u32, SLOTISR_VER_SPEC, u8, u8, 8, 0>;
impl R {
