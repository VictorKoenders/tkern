...
pub type TX_FIFO_LEVEL_W<'a> = crate::FieldWriter<'a, u32, STAT_SPEC, u8, u8, 4, 24>;
...
pub type RX_FIFO_LEVEL_W<'a> = crate::FieldWriter<'a, u32, STAT_SPEC, u8, u8, 4, 16>;
...
pub type TX_DONE_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 9>;
...
pub type TX_FULL_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 5>;
...
pub type RX_OVERRUN_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 4>;
...
pub type TX_IDLE_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 3>;
...
pub type RX_IDLE_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 2>;
...
pub type TX_READY_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 1>;
...
pub type DATA_READY_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 0>;
impl R {
