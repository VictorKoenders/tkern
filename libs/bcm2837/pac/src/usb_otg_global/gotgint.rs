...
pub type SEDET_W<'a> = crate::BitWriter<'a, u32, GOTGINT_SPEC, bool, 2>;
...
pub type SRSSCHG_W<'a> = crate::BitWriter<'a, u32, GOTGINT_SPEC, bool, 8>;
...
pub type HNSSCHG_W<'a> = crate::BitWriter<'a, u32, GOTGINT_SPEC, bool, 9>;
...
pub type HNGDET_W<'a> = crate::BitWriter<'a, u32, GOTGINT_SPEC, bool, 17>;
...
pub type ADTOCHG_W<'a> = crate::BitWriter<'a, u32, GOTGINT_SPEC, bool, 18>;
#[doc = "Field `DBCDNE` reader - Debounce done"]
pub type DBCDNE_R = crate::BitReader<bool>;
#[doc = "Field `DBCDNE` writer - Debounce done"]
pub type DBCDNE_W<'a> = crate::BitWriter<'a, u32, GOTGINT_SPEC, bool, 19>;
impl R {
