...
pub type NPTXFSA_W<'a> = crate::FieldWriter<'a, u32, GNPTXFSIZ_HOST_SPEC, u16, u16, 16, 0>;
...
pub type NPTXFD_W<'a> = crate::FieldWriter<'a, u32, GNPTXFSIZ_HOST_SPEC, u16, u16, 16, 16>;
impl R {
