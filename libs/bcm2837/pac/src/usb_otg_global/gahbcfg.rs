...
pub type GINT_W<'a> = crate::BitWriter<'a, u32, GAHBCFG_SPEC, bool, 0>;
...
pub type AXI_WAIT_W<'a> = crate::BitWriter<'a, u32, GAHBCFG_SPEC, bool, 4>;
...
pub type AXI_BURST_R = crate::FieldReader<u8, AXI_BURST_A>;
impl AXI_BURST_R {
...
pub type AXI_BURST_W<'a> = crate::FieldWriterSafe<'a, u32, GAHBCFG_SPEC, u8, AXI_BURST_A, 2, 1>;
...
pub type TXFELVL_W<'a> = crate::BitWriter<'a, u32, GAHBCFG_SPEC, bool, 7>;
...
pub type PTXFELVL_W<'a> = crate::BitWriter<'a, u32, GAHBCFG_SPEC, bool, 8>;
impl R {
