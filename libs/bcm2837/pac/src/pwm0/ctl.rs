...
pub type MSEN2_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 15>;
...
pub type USEF2_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 13>;
...
pub type POLA2_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 12>;
...
pub type SBIT2_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 11>;
...
pub type RPTL2_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 10>;
#[doc = "Channel 2 mode\n\nValue on reset: 0"]
...
pub type MODE2_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, MODE2_A, 9>;
impl<'a> MODE2_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type PWEN2_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 8>;
...
pub type MSEN1_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 7>;
#[doc = "Field `CLRF1` reader - Clear FIFO"]
pub type CLRF1_R = crate::BitReader<bool>;
#[doc = "Field `CLRF1` writer - Clear FIFO"]
pub type CLRF1_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 6>;
...
pub type USEF1_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 5>;
...
pub type POLA1_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 4>;
...
pub type SBIT1_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 3>;
...
pub type RPTL1_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 2>;
#[doc = "Channel 1 mode\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum MODE1_A {
    #[doc = "0: `0`"]
...
pub type MODE1_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, MODE1_A, 1>;
impl<'a> MODE1_W<'a> {
    #[doc = "`0`"]
    #[inline(always)]
    pub fn pwm(self) -> &'a mut W {
...
pub type PWEN1_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, bool, 0>;
impl R {
