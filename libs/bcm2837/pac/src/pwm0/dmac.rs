...
pub type ENAB_W<'a> = crate::BitWriter<'a, u32, DMAC_SPEC, bool, 31>;
...
pub type PANIC_W<'a> = crate::FieldWriter<'a, u32, DMAC_SPEC, u8, u8, 8, 8>;
...
pub type DREQ_W<'a> = crate::FieldWriter<'a, u32, DMAC_SPEC, u8, u8, 8, 0>;
impl R {
