...
pub type DSPD_W<'a> = crate::FieldWriter<'a, u32, DCFG_SPEC, u8, u8, 2, 0>;
...
pub type NZLSOHSK_W<'a> = crate::BitWriter<'a, u32, DCFG_SPEC, bool, 2>;
#[doc = "Field `DAD` reader - Device address"]
pub type DAD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DAD` writer - Device address"]
pub type DAD_W<'a> = crate::FieldWriter<'a, u32, DCFG_SPEC, u8, u8, 7, 4>;
...
pub type PFIVL_W<'a> = crate::FieldWriter<'a, u32, DCFG_SPEC, u8, u8, 2, 11>;
...
pub type PERSCHIVL_W<'a> = crate::FieldWriter<'a, u32, DCFG_SPEC, u8, u8, 2, 24>;
impl R {
