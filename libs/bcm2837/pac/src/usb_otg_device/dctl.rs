...
pub type RWUSIG_W<'a> = crate::BitWriter<'a, u32, DCTL_SPEC, bool, 0>;
#[doc = "Field `SDIS` reader - Soft disconnect"]
pub type SDIS_R = crate::BitReader<bool>;
#[doc = "Field `SDIS` writer - Soft disconnect"]
pub type SDIS_W<'a> = crate::BitWriter<'a, u32, DCTL_SPEC, bool, 1>;
...
pub type TCTL_W<'a> = crate::FieldWriter<'a, u32, DCTL_SPEC, u8, u8, 3, 4>;
...
pub type POPRGDNE_W<'a> = crate::BitWriter<'a, u32, DCTL_SPEC, bool, 11>;
impl R {
