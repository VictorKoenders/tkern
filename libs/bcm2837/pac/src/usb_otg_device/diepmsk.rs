...
pub type XFRCM_W<'a> = crate::BitWriter<'a, u32, DIEPMSK_SPEC, bool, 0>;
...
pub type EPDM_W<'a> = crate::BitWriter<'a, u32, DIEPMSK_SPEC, bool, 1>;
...
pub type TOM_W<'a> = crate::BitWriter<'a, u32, DIEPMSK_SPEC, bool, 3>;
...
pub type ITTXFEMSK_W<'a> = crate::BitWriter<'a, u32, DIEPMSK_SPEC, bool, 4>;
...
pub type INEPNMM_W<'a> = crate::BitWriter<'a, u32, DIEPMSK_SPEC, bool, 5>;
...
pub type INEPNEM_W<'a> = crate::BitWriter<'a, u32, DIEPMSK_SPEC, bool, 6>;
...
pub type TXFURM_W<'a> = crate::BitWriter<'a, u32, DIEPMSK_SPEC, bool, 8>;
#[doc = "Field `BIM` reader - BNA interrupt mask"]
pub type BIM_R = crate::BitReader<bool>;
#[doc = "Field `BIM` writer - BNA interrupt mask"]
pub type BIM_W<'a> = crate::BitWriter<'a, u32, DIEPMSK_SPEC, bool, 9>;
impl R {
