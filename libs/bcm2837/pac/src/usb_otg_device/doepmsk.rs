...
pub type XFRCM_W<'a> = crate::BitWriter<'a, u32, DOEPMSK_SPEC, bool, 0>;
...
pub type EPDM_W<'a> = crate::BitWriter<'a, u32, DOEPMSK_SPEC, bool, 1>;
...
pub type STUPM_W<'a> = crate::BitWriter<'a, u32, DOEPMSK_SPEC, bool, 3>;
...
pub type OTEPDM_W<'a> = crate::BitWriter<'a, u32, DOEPMSK_SPEC, bool, 4>;
...
pub type B2BSTUP_W<'a> = crate::BitWriter<'a, u32, DOEPMSK_SPEC, bool, 6>;
...
pub type OPEM_W<'a> = crate::BitWriter<'a, u32, DOEPMSK_SPEC, bool, 8>;
#[doc = "Field `BOIM` reader - BNA interrupt mask"]
pub type BOIM_R = crate::BitReader<bool>;
#[doc = "Field `BOIM` writer - BNA interrupt mask"]
pub type BOIM_W<'a> = crate::BitWriter<'a, u32, DOEPMSK_SPEC, bool, 9>;
impl R {
