...
pub type CLKT_W<'a> = crate::BitWriter1C<'a, u32, S_SPEC, bool, 9>;
#[doc = "Field `ERR` reader - Error: No ack"]
pub type ERR_R = crate::BitReader<bool>;
#[doc = "Field `ERR` writer - Error: No ack"]
pub type ERR_W<'a> = crate::BitWriter1C<'a, u32, S_SPEC, bool, 8>;
...
pub type DONE_W<'a> = crate::BitWriter1C<'a, u32, S_SPEC, bool, 1>;
