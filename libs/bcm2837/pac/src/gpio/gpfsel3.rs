...
pub type FSEL30_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL30_A, 3, 0>;
impl<'a> FSEL30_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
...
pub type FSEL31_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL31_A, 3, 3>;
impl<'a> FSEL31_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL32_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL32_A, 3, 6>;
impl<'a> FSEL32_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL33_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL33_A, 3, 9>;
impl<'a> FSEL33_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL34_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL34_A, 3, 12>;
impl<'a> FSEL34_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL35_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL35_A, 3, 15>;
impl<'a> FSEL35_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL36_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL36_A, 3, 18>;
impl<'a> FSEL36_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL37_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL37_A, 3, 21>;
impl<'a> FSEL37_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL38_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL38_A, 3, 24>;
impl<'a> FSEL38_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL39_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL3_SPEC, u8, FSEL39_A, 3, 27>;
impl<'a> FSEL39_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
