...
pub type FSEL10_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL10_A, 3, 0>;
impl<'a> FSEL10_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
...
pub type FSEL11_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL11_A, 3, 3>;
impl<'a> FSEL11_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL12_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL12_A, 3, 6>;
impl<'a> FSEL12_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL13_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL13_A, 3, 9>;
impl<'a> FSEL13_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL14_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL14_A, 3, 12>;
impl<'a> FSEL14_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL15_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL15_A, 3, 15>;
impl<'a> FSEL15_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL16_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL16_A, 3, 18>;
impl<'a> FSEL16_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL17_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL17_A, 3, 21>;
impl<'a> FSEL17_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL18_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL18_A, 3, 24>;
impl<'a> FSEL18_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL19_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL1_SPEC, u8, FSEL19_A, 3, 27>;
impl<'a> FSEL19_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
