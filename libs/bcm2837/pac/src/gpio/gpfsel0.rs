...
pub type FSEL0_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL0_A, 3, 0>;
impl<'a> FSEL0_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
...
pub type FSEL1_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL1_A, 3, 3>;
impl<'a> FSEL1_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL2_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL2_A, 3, 6>;
impl<'a> FSEL2_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL3_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL3_A, 3, 9>;
impl<'a> FSEL3_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL4_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL4_A, 3, 12>;
impl<'a> FSEL4_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL5_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL5_A, 3, 15>;
impl<'a> FSEL5_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL6_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL6_A, 3, 18>;
impl<'a> FSEL6_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL7_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL7_A, 3, 21>;
impl<'a> FSEL7_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL8_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL8_A, 3, 24>;
impl<'a> FSEL8_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL9_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL0_SPEC, u8, FSEL9_A, 3, 27>;
impl<'a> FSEL9_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
