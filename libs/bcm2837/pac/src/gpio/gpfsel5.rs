...
pub type FSEL50_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL5_SPEC, u8, FSEL50_A, 3, 0>;
impl<'a> FSEL50_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
...
pub type FSEL51_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL5_SPEC, u8, FSEL51_A, 3, 3>;
impl<'a> FSEL51_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL52_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL5_SPEC, u8, FSEL52_A, 3, 6>;
impl<'a> FSEL52_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL53_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL5_SPEC, u8, FSEL53_A, 3, 9>;
impl<'a> FSEL53_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
