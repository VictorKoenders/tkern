...
pub type FSEL40_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL40_A, 3, 0>;
impl<'a> FSEL40_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
...
pub type FSEL41_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL41_A, 3, 3>;
impl<'a> FSEL41_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL42_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL42_A, 3, 6>;
impl<'a> FSEL42_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL43_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL43_A, 3, 9>;
impl<'a> FSEL43_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL44_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL44_A, 3, 12>;
impl<'a> FSEL44_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL45_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL45_A, 3, 15>;
impl<'a> FSEL45_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL46_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL46_A, 3, 18>;
impl<'a> FSEL46_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL47_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL47_A, 3, 21>;
impl<'a> FSEL47_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL48_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL48_A, 3, 24>;
impl<'a> FSEL48_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL49_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL4_SPEC, u8, FSEL49_A, 3, 27>;
impl<'a> FSEL49_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
