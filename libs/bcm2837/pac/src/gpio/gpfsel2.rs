...
pub type FSEL20_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL20_A, 3, 0>;
impl<'a> FSEL20_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
...
pub type FSEL21_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL21_A, 3, 3>;
impl<'a> FSEL21_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL22_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL22_A, 3, 6>;
impl<'a> FSEL22_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL23_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL23_A, 3, 9>;
impl<'a> FSEL23_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL24_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL24_A, 3, 12>;
impl<'a> FSEL24_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL25_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL25_A, 3, 15>;
impl<'a> FSEL25_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL26_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL26_A, 3, 18>;
impl<'a> FSEL26_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL27_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL27_A, 3, 21>;
impl<'a> FSEL27_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL28_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL28_A, 3, 24>;
impl<'a> FSEL28_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
...
pub type FSEL29_W<'a> = crate::FieldWriterSafe<'a, u32, GPFSEL2_SPEC, u8, FSEL29_A, 3, 27>;
impl<'a> FSEL29_W<'a> {
    #[doc = "Pin is an input"]
    #[inline(always)]
    pub fn input(self) -> &'a mut W {
